...
- [📈 Этап 7. Построение дашборда](#stage7)
...
- читают CSV-файл с численностью населения и полигонами регионов;
- приводит данные населения к long-формату;
- нормализует название региона, проверяет JSON-полигон;
- готовят данные для public.tb_population и public.tb_regions.
...
## 📈 Этап 7. Построение дашборда

**BI-система:**
- `Yandex DataLens`

**Ссылка на дашборд:**
- [Медико-статистический мониторинг туберкулёза: РФ и Иркутская область](https://datalens.ru/4eun4nsqtcx0o)
