# ETL медицинской статистики по туберкулезу
...
DOCX, PDF и CSV-источники, нормализовать данные в long-формат, загрузить их в
...
- парсеры получают список файлов из `etl_source_files`, а не из вручную заданных
  абсолютных путей;
...
- индексы и ограничения описаны в коде проекта, а не вручную в интерфейсе БД.
